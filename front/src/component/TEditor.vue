...
export default {
    ...
    props: {
        ...
        plugins: {
            type: [String, Array],
            default: 'preview searchreplace autolink directionality visualblocks visualchars fullscreen image link media template table charmap pagebreak nonbreaking anchor insertdatetime advlist lists wordcount code codesample '
            // default: ''
        },
        toolbar: {
            type: [String, Array],
            default: 'fullscreen code undo redo restoredraft | \
             cut copy paste pastetext | \
              forecolor backcolor bold italic underline strikethrough link anchor | \
               alignleft aligncenter alignright alignjustify outdent indent | \
                ...
                table image media charmap pagebreak insertdatetime preview | \
                selectall searchreplace visualblocks | \
                indent2em lineheight formatpainter axupimgs'
            // default: ''
        },
    },
    data() {
